...
//			MazePrinter.printMaze(maze);
			System.out.println(solver.pathSearch(0, 0, 0, 0, 3));
			System.out.println(solver.pathSearch(0, 0, 0, 1, 3));
			System.out.println(solver.pathSearch(0, 0, 0, 2, 3));
			System.out.println(solver.pathSearch(0, 0, 0, 3, 3));

			System.out.println(solver.pathSearch(0, 0, 1, 0, 3));
			System.out.println(solver.pathSearch(0, 0, 1, 1, 3));
			System.out.println(solver.pathSearch(0, 0, 1, 2, 3));
			System.out.println(solver.pathSearch(0, 0, 1, 3, 3));

			System.out.println(solver.pathSearch(0, 0, 2, 0, 3));
			System.out.println(solver.pathSearch(0, 0, 2, 1, 3));
			System.out.println(solver.pathSearch(0, 0, 2, 2, 3));
			System.out.println(solver.pathSearch(0, 0, 2, 3, 3));

			System.out.println(solver.pathSearch(0, 0, 3, 0, 3));
			System.out.println(solver.pathSearch(0, 0, 3, 1, 3));
			System.out.println(solver.pathSearch(0, 0, 3, 2, 3));
